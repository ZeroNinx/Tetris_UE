...
static struct FScriptStruct_Tetris_UE_StaticRegisterNativesFPoint
{
	...
	DEFINE_FUNCTION(ABlock::execSetBlockMaterial)
	{
		P_GET_OBJECT(UMaterialInterface,Z_Param_material);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetBlockMaterial(Z_Param_material);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ABlock::execSpin_L)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Spin_L();
	...
	void ABlock::StaticRegisterNativesABlock()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetBlockMaterial", &ABlock::execSetBlockMaterial },
	...
	struct Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics
	{
		struct Block_eventSetBlockMaterial_Parms
		{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::NewProp_material = { "material", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Block_eventSetBlockMaterial_Parms, material), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::NewProp_material,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//?\xe8\xb6\xa8????????\n" },
		{ "ModuleRelativePath", "Block.h" },
		{ "ToolTip", "?\xe8\xb6\xa8????????" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABlock, nullptr, "SetBlockMaterial", nullptr, nullptr, sizeof(Block_eventSetBlockMaterial_Parms), Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ABlock_SetBlockMaterial()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ABlock_SetBlockMaterial_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ABlock_Spin_L_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABlock_Spin_L_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//????\xd7\xaa\n" },
		{ "ModuleRelativePath", "Block.h" },
		{ "ToolTip", "????\xd7\xaa" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABlock_Spin_L_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABlock, nullptr, "Spin_L", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABlock_Spin_L_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlock_Spin_L_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ABlock_Spin_L()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ABlock_Spin_L_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ABlock_Spin_R_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABlock_Spin_R_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//????\xd7\xaa\n" },
		{ "ModuleRelativePath", "Block.h" },
		{ "ToolTip", "????\xd7\xaa" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABlock_Spin_R_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABlock, nullptr, "Spin_R", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABlock_Spin_R_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlock_Spin_R_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ABlock_Spin_R()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ABlock_Spin_R_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABlock_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ABlock_SetBlockMaterial, "SetBlockMaterial" }, // 2185462302
	...
	IMPLEMENT_CLASS(ABlock, 2759134366);
